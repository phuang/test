...
*/                
                ...
                for (int x = 1; x < X_SIZE+1; x++){
                    for (int y = 1; y < Y_SIZE+1; y++){
                        if (north[x][y]){
                            g.drawLine(x * zoomPixel , (y+1) * zoomPixel, (x +1) * zoomPixel , (y+1) * zoomPixel);
                        }
                        ...
                        if (east[x][y]){
                            g.drawLine((x+1) * zoomPixel , y * zoomPixel, (x +1) * zoomPixel , (y+1) * zoomPixel);
                        }
                ...
                if (current_ !=  null) {
                    ...
                    g.fillRect(current_.getX()*zoomPixel + 2 , current_.getY()*zoomPixel + 2, zoomPixel - 4, zoomPixel - 4);
                }
            }
 
 
            public Dimension getPreferredSize(){
                return new Dimension((X_SIZE+2) * pixel + zoomPixel * 2, (Y_SIZE+2) * pixel + zoomPixel * 2);
            }
