...
const struct wl_pointer_listener Pointer::listener_ = {
    Pointer::OnEnterThunk,      Pointer::OnLeaveThunk,
    Pointer::OnMotionThunk,     Pointer::OnButtonThunk,
    Pointer::OnAxisThunk,       Pointer::OnFrameThunk,
    Pointer::OnAxisSourceThunk, Pointer::OnAxisStopThunk,
};
